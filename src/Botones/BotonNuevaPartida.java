...
public class BotonNuevaPartida extends JLabel {
	...
	public BotonNuevaPartida(JF_PanelMenu JF_PanelMenu) {
		...
		setIcon(img.tamaño(new ImageIcon("botones/bottonNuevaPartida-1.png"), ((int)(screenSize.getWidth()/5)), ((int)(screenSize.getWidth()/20))));
		
		addMouseListener(new MouseListener() {	
			
			
			public void mouseEntered(MouseEvent e) {
				setIcon(img.tamaño(new ImageIcon("botones/bottonNuevaPartida-2.png"),((int)(screenSize.getWidth()/5)) , ((int)(screenSize.getWidth()/20))));
			}
